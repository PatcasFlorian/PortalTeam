...
<h3 id="myHeader" > <a style="color:red" href="back-userlist.htm"><==Back</a> Forex-Trade  <a style="color:red" href="login-portal.htm">. LogOut</a></h3>
<h3 id="myHeader"><button id="button2" onclick="location.href='view-sale.htm'" type="button">ListareAnuntVanzare</button><button id="button2" onclick="location.href='#'" type="button">ListareAnuntCumparare</button><button id="button2" onclick="#'" type="button">ListareComentariiForum</button>  </h3>

...
<h3 id="myHeader"> <a style="color:red" href="home.htm"  metod="post" commandName="isLogin"  >DashBoard</a>  Forex-Trade  <a  style="color:red" href="login-portal.htm">. LogOut</a> </h3>

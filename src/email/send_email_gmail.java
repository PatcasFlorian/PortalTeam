	...
	public static void sendAdminEmail() {
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO,
				InternetAddress.parse("florentinapatcas@gmail.com"));
			message.setSubject("Testing Subject");
			message.setText(" Email trimis de www.forex-trade.ro,Aveti un nou client care asteapta acceptul dumneavoastra"
